...
{
    [Serializable]
    public class BEServicios : Utilitarios.Base 
    {
        ...
        private string LCM_NUMFOX_MOD = string.Empty;
        private string COD_MUESTRA = string.Empty;
        ...
        public string Lcm_Numfox_Mod
        {
            get { return LCM_NUMFOX_MOD; }
            set { LCM_NUMFOX_MOD = value; }
        }
        
        public string Cod_Muestra
        {
            get { return COD_MUESTRA; }
            set { COD_MUESTRA = value; }
        }
        //
        ...
        public void Cargar(System.Data.IDataReader objDataReader)
        {
            ...
            CargarVariable(objDataReader, "NUMFOX_MOD", out LCM_NUMFOX_MOD);
           ...
           // CargarVariable(objDataReader, "DESSER", out DESSER);
            ...
            CargarVariable(objDataReader, "COD_MUESTRA", out COD_MUESTRA);
